...
$csvArray =  array_map('str_getcsv', file('/Applications/MAMP/htdocs/UrlToHtml_NBCNews.csv'));
$count =0;
$pre="";
// display results
if ($results)
...
<?php
  ...
  foreach ($results->response->docs as $doc)
  {
    ...
    $id = $doc->id;
    $or_id = $id;
    $id = str_replace("/Users/prakharsethi/Desktop/ntemp/solr-7.3.0/crawl_data/","",$id);
    ...
    $html_to_text_files_dir = "/Users/prakharsethi/Desktop/ntemp/solr-7.3.0/crawl_data/";///////
